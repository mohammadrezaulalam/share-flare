    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          ...
          child: Image.asset(SFAssetsPath.personPNG,),
        ),
                  ...
                  child: ListView.separated(
                      ...
                      return GestureDetector(
                        onTap: (){
                          ...
                          _selectedColors[_selectedIndex] = SFColors.storyLiveColor;
                          setState(() {});
                        },
                        child: Card(
                          elevation: 0,
                          ...
                          child: Column(
                            children: [
                              Stack(
                                children: [
                                  Image.asset(storyItems[index]['img']!,height: 150,),
                                  if(index ==0)
                                    const Positioned(
                                        top: 60,
                                        left: 40,
                                        child: Icon(Icons.add,color: SFColors.white,size: 35,),
                                    ),
                                  Positioned(
                                      top: 5,
                                      left: 5,
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: Colors.blue,
                                          shape: BoxShape.circle,
                                          border: Border.all(color:_selectedColors.containsKey(index) ? SFColors.storyLiveColor : SFColors.buttonActiveColor,width: 2),
                                          image: DecorationImage(image: AssetImage(storyItems[index]['img']!),fit: BoxFit.cover,
