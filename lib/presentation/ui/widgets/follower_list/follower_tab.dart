...
class FollowerTabBar extends StatelessWidget {
  FollowerTabBar(
      {super.key, required this.followingList, required this.followerList});
              ...
              children: [
                TabBar(
                  ...
                  unselectedLabelColor:
                      dark ? const Color(0xFF1D2939) : const Color(0xFF1D2939),
                  ...
                  indicator: UnderlineTabIndicator(
                    borderSide: BorderSide(
                        width: 1.0,
                        color: dark ? SFColors.white : const Color(0xFF667085)),
                    ...
                    Tab(
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 13,
                            color:
                                dark ? SFColors.white : const Color(0xFF1D2939),
